...
class Menu:
    def __init__(self, config, on_start_chat, on_quit, on_show_history, on_show_help, on_show_model_menu, on_show_about):
        self.config = config
        ...
        menu_items = [start_chat_btn, history_btn, help_btn, about_btn, quit_btn]
